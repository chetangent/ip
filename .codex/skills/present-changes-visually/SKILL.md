...
description: Generate a self-contained, GitHub-style split-view HTML page that visually presents changes in this repository. Use when asked to show, review, share, or inspect code changes visually; compare revisions, branches, commits, or the worktree; or create an HTML diff for this project.
---

# Present Changes Visually

Generate one interactive HTML page containing every changed file as a side-by-side before/after diff. Fold long unchanged runs, highlight changed words within modified lines, let readers filter files, and include collapsed panels for unchanged files.
